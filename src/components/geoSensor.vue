  ...
  <div>
    ...
    <div class="index-filter-container">
      <el-form :model="searchInfo" :inline="true" ref="searchInfo" label-position="left" label-width="0px" class="demo-ruleForm card-box loginform">
        ...
        <el-form-item prop="gatewayId">
          <el-select v-model="searchInfo.gatewayId"  placeholder="所属网关" clearable>
            <el-option
        ...
        <el-form-item>
          <el-button class="filter-item" style="margin-left: 10px;" @click="_clickFlag('add', '新增地磁')" type="primary" icon="edit">添加</el-button>
        </el-form-item>
      </el-form>
    </div>
    <!-------------------------------------列表-栏目------------------------>
    <div class="index-main-table">
      <el-table :data="list"  border v-loading="listLoading" element-loading-text="正在加载中" fit highlight-current-row  style="width: 100%" >
        ...
        <el-table-column prop="type" label="类型" min-width="15%" align="center"></el-table-column>
        <el-table-column prop="gatewayCode" label="所属网关" min-width="15%" align="center"></el-table-column>
        <el-table-column prop="deviceStatus" label="设备状态" min-width="15%" align="center"></el-table-column>
        <el-table-column prop="batteryCapacity" label="电池容量" min-width="15%" align="center"></el-table-column>
        ...
        <el-table-column align="left" label="操作" min-width="10%" header-align="center">
          <template slot-scope="scope">
            <el-button size="small" type="info" @click="_clickFlag('edit', '', '编辑地磁', scope.row)">编辑</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
      ...
      <el-form ref="dialogInfo" :model="dialogInfo" :rules="rules">
        ...
        <el-form-item label="类型" :label-width="formLabelWidth" prop="type">
          <el-radio-group v-model="dialogInfo.type">
            <el-radio :label="1">流量地磁</el-radio>
            <el-radio :label="2">泊位地磁</el-radio>
          </el-radio-group>
        </el-form-item>
        ...
        <el-form-item label="所属网关" :label-width="formLabelWidth" prop="gatewayId">
